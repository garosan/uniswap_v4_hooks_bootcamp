# Grupo de Estudio de Uniswap V4 Hooks 🪝
...
- [Sesión 07 – Liquidity Operators I: Limit Orders (Take-Profit)](./session_07.md)
- [Sesión 08 – Liquidity Operators II: Ejecución & JIT Rebalancing](./session_08.md)
- [Sesión 09 – Return-Delta Hooks: Curvas personalizadas y MEV Mitigation](./session_09.md)
- [Sesión 10 – Periphery avanzado: Router Swap + Bridge & Conclusión](./session_10.md)

## 🛠️ Recursos

- [🦄 Uniswap Official Docs](https://docs.uniswap.org/)
- [🦄 Uniswap Official Blog](https://blog.uniswap.org/)
- [Uniswap Hook Incubator](https://atrium.academy/uniswap)

## 🎤 Podcasts, Entrevistas, Videos

- [Unchained Podcast - What Makes Uniswap v4 Special - Ep. 508](https://youtu.be/KNK-W8JDuWg)
- [Bankless - Uniswap V4 ANNOUNCED By Founder Hayden Adams](https://www.youtube.com/watch?v=ZmhdNiGOMRU)
